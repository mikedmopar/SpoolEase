...
use settings::{
    ...
    WEB_REQUEST_BODY_MAX_BYTES, WEB_SERVER_CAPTIVE, WEB_SERVER_HTTP_BUFFER_BYTES, WEB_SERVER_HTTP_RETAINED_BUFFERS, WEB_SERVER_HTTPS,
    WEB_SERVER_PORT, WEB_SERVER_TCP_RX_BUFFER_BYTES, WEB_SERVER_TCP_TX_BUFFER_BYTES, WEB_SERVER_TLS_CERTIFICATE, WEB_SERVER_TLS_PRIVATE_KEY,
};
    ...
    let web_server_runner = mk_static!(
        ...
        framework::web_server::WebAppRunner::new(
            ...
            framework::web_server::WebServerBufferSizes {
                ...
                http_retained: WEB_SERVER_HTTP_RETAINED_BUFFERS,
            },
        )
    );
