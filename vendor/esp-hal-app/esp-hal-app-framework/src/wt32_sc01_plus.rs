...
use esp_hal::{
    ...
    lcd_cam::{lcd::i8080::I8080Transfer, LcdCam},
...
use crate::{
    backlight::BacklightDevice, framework::Framework, ft6x36_adapter::Ft6x36TouchAdapter,
    mk_static, sdcard_spi::create_sdcard_spi_device_dma, slint_ext::McuWindow, touch::Touch,
